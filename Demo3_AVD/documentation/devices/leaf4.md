...
| --------- | --------------- | ------------ | --------- |
| mlag2 | Vlan4094 | 172.16.12.4 | Port-Channel1 |
...
| Ethernet10 | Connection to host2 | *access | *200 | *- | *- | 10 |
| Ethernet11 | Connection to host2 | *access | *200 | *- | *- | 11 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet6 | - | 172.16.13.13/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet6 | - | 172.16.13.15/31 | default | 1550 | False | - | - |
...
| Port-Channel10 | - | access | 200 | - | - | - | - | 10 | - |
| Port-Channel11 | - | access | 200 | - | - | - | - | 11 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 172.16.10.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 172.16.11.3/32 |
...
| Vlan3009 |  VRF_A  |  172.16.12.133/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.12.133/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.16.12.5/31  |  -  |  -  |  -  |  -  |
...
| 172.16.12.132 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.16.13.12 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.13.14 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.12.132 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 172.16.10.4:10100 | 10100:10100 | - | - | learned |
| 200 | 172.16.10.4:10200 | 10200:10200 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 172.16.10.4:10 | connected |
...
router bgp 65299
   ...
   neighbor 172.16.12.132 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.12.132 description leaf3_Vlan4093
   neighbor 172.16.13.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.13.12 remote-as 65001
   neighbor 172.16.13.12 description spine1_Ethernet6
   neighbor 172.16.13.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.13.14 remote-as 65001
   neighbor 172.16.13.14 description spine2_Ethernet6
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 100
      rd 172.16.10.4:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 200
      rd 172.16.10.4:10200
   ...
   vrf VRF_A
      ...
      router-id 172.16.10.4
      neighbor 172.16.12.132 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 172.16.12.132 description leaf3_Vlan3009
