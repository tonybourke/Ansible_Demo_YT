...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.11/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| mlag1 | Vlan4094 | 172.16.12.1 | Port-Channel1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet3 | - | 172.16.13.1/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet3 | - | 172.16.13.3/31 | default | 1550 | False | - | - |
...
| Vlan3009 |  VRF_A  |  172.16.12.128/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.12.128/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.16.12.0/31  |  -  |  -  |  -  |  -  |
...
| 172.16.12.129 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.16.13.0 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.13.2 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.12.129 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 172.16.10.1:10100 | 10100:10100 | - | - | learned |
| 200 | 172.16.10.1:10200 | 10200:10200 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 172.16.10.1:10 | connected |
...
router bgp 65002
   ...
   neighbor 172.16.12.129 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.16.12.129 description leaf2_Vlan4093
   neighbor 172.16.13.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.13.0 remote-as 65001
   neighbor 172.16.13.0 description spine1_Ethernet3
   neighbor 172.16.13.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.13.2 remote-as 65001
   neighbor 172.16.13.2 description spine2_Ethernet3
   ...
   vrf VRF_A
      ...
      router-id 172.16.10.1
      neighbor 172.16.12.129 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 172.16.12.129 description leaf2_Vlan3009
